    ...
    return (
        <div>
            ...
            <div className = "flex flex-col h-1/2 w-3/5 justify-center font-crimson justify-self-center mt-5">
                <p className=" justify-self-center text-[48px] font-bold">What are you removing?</p>
                <div className = "font-bold text-[36px] py-5">
                ...
                <div className = "font-bold text-[36px] pt-10 -p-10">
